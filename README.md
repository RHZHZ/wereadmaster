...
- 手机端阅读报告图片支持直接保存到系统相册，也可以调用系统分享面板继续发送。
- 设置页新增“关于与支持”，可以直接查看 GitHub、联系作者和查看自愿赞赏说明。
- 官网下载页补充平台说明、常见问题和更新说明入口，更清楚地区分 Windows 安装包与 Android 签名 APK。
...
- 支持 Markdown 导出、批量导出、导出报告和索引；移动端阅读报告图片可直接保存到系统相册或通过系统分享。
